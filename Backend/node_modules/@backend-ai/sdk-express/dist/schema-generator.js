...
class SchemaGenerator {
    constructor(apiKey, modelName = 'gemini-2.5-flash', verbose = false) {
        this.genAI = null;
        this.model = null;
     ...
     */
    async generateToolDefinition(route) {
     ...
     */
    async generateSemanticMeta(route) {
        if (!this.model) {
...
`;
     ...
     * Generate input schema using AI
     */
    async generateInputSchema(route) {
        if (!this.model) {
...
`;
     ...
     */
    enrichProperties(properties, parentName = '') {
        const enriched = {};
